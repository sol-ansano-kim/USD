...
# Form implementation generated from reading ui file '/Users/sol/dev/lib/USD/pxr/usdImaging/lib/usdviewq/propertyLegendUI.ui'
#
...
"  ", None))
        self.propertyLegendLabelNoValue.setText(QtWidgets.QApplication.translate("PropertyLegend", "No Value", None))
        self.propertyLegendLabelDefault.setText(QtWidgets.QApplication.translate("PropertyLegend", "Default", None))
        self.propertyLegendLabelTimeSample.setText(QtWidgets.QApplication.translate("PropertyLegend", "Time Samples (Interpolated) ", None))
        self.propertyLegendLabelFallback.setText(QtWidgets.QApplication.translate("PropertyLegend", "Fallback", None))
        self.propertyLegendLabelCustom.setText(QtWidgets.QApplication.translate("PropertyLegend", "Custom", None))
        self.propertyLegendLabelValueClips.setText(QtWidgets.QApplication.translate("PropertyLegend", "Value Clips (Interpolated)", None))
        self.propertyLegendAttrPlainDesc.setText(QtWidgets.QApplication.translate("PropertyLegend", "Attribute", None))
        self.propertyLegendRelPlainDesc.setText(QtWidgets.QApplication.translate("PropertyLegend", "Relationship", None))
        self.propertyLegendCompDesc.setText(QtWidgets.QApplication.translate("PropertyLegend", "Computed Value", None))
        self.propertyLegendConnDesc.setText(QtWidgets.QApplication.translate("PropertyLegend", "Connection", None))
        self.propertyLegendTargetDesc.setText(QtWidgets.QApplication.translate("PropertyLegend", "Target", None))
        self.inheritedPropertyIcon.setText(QtWidgets.QApplication.translate("PropertyLegend", "<small><i>(i)</i></small>", None))
        self.inheritedPropertyText.setText(QtWidgets.QApplication.translate("PropertyLegend", "Inherited Property", None))
        self.propertyLegendAttrWithConnDesc.setText(QtWidgets.QApplication.translate("PropertyLegend", "Attribute w/Connection(s)", None))
        self.propertyLegendRelWithTargetDesc.setText(QtWidgets.QApplication.translate("PropertyLegend", "Relationship w/Target(s)", None))
